...
# forecasting task
parser.add_argument('--c_in', type=int, default=7, help='input sequence length')
...
# Formers 
parser.add_argument('--embed_type', type=int, default=4, help='0: default 1: value embedding + temporal embedding + positional embedding 2: value embedding + temporal embedding 3: value embedding + positional embedding 4: value embedding')
